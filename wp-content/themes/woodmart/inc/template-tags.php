						...
						<div class="blog-footer">
							<?php if ( $pagination == 'infinit' || $pagination == 'load_more' ) : ?>
								<?php if ( get_next_posts_link() ) : ?>
									<a href="<?php echo add_query_arg( 'woo_ajax', '1', next_posts( $max_page, false ) ); ?>" rel="nofollow" data-holder-id="<?php echo esc_attr( $id ); ?>" class="btn woodmart-load-more woodmart-blog-load-more load-on-<?php echo 'load_more' === $pagination ? 'click' : 'scroll'; ?>"><span class="load-more-label"><?php esc_html_e( 'Load more posts', 'woodmart' ); ?></span></a>
...
if ( ! function_exists( 'woodmart_page_title' ) ) {
	...
	function woodmart_page_title() {
		...
		if ( is_single() && $single_post_design == 'large_image' ) {
			$disable = false;
		}
					...
					<div class="container">
						<header class="entry-header">
							...
							<?php else : ?>
								...
								if ( $page_title ) :
									?>
									<h1 class="entry-title"><?php echo esc_html( $title ); ?></h1><?php endif; ?>
								<?php
								if ( $breadcrumbs ) {
...
if ( ! function_exists( 'woodmart_mobile_menu' ) ) {
	function woodmart_mobile_menu() {
		...
		$nav_classes .= ' slide-from-' . $position;
		...
		if ( isset( $settings['burger']['tabs_swap'] ) && $settings['burger']['tabs_swap'] ) {
			...
			$nav_classes      .= ' wd-mobile-tabs-swap';
		}
		...
		if ( $mobile_categories ) {
			?>
					<div class="mobile-nav-tabs">
						<ul>
							<li class="mobile-tab-title mobile-pages-title <?php echo esc_attr( $pages_active ); ?>" data-menu="pages"><span><?php esc_html_e( 'Menu', 'woodmart' ); ?></span></li>
							<li class="mobile-tab-title mobile-categories-title <?php echo esc_attr( $categories_active ); ?>" data-menu="categories"><span><?php esc_html_e( 'Categories', 'woodmart' ); ?></span></li>
						</ul>
					</div>
				<?php
				echo '<div class="mobile-menu-tab mobile-categories-menu ' . esc_attr( $categories_active ) . '">';
			...
			echo '<div class="mobile-menu-tab mobile-pages-menu ' . esc_attr( $pages_active ) . '">';
