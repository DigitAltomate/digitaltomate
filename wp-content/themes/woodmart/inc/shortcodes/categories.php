...
if( ! function_exists( 'woodmart_shortcode_categories' ) ) {
	function woodmart_shortcode_categories( $atts, $content ) {
		...
		if ( $style == 'carousel' ) {
			$extra_class .= ' woodmart-carousel-spacing-' . $spacing;
		} else {
		...
		if ( $product_categories ) {
			...
			if ( $style == 'carousel' ) {
				...
				<div id="<?php echo esc_attr( $carousel_id ); ?>" class="products woocommerce woodmart-carousel-container <?php echo esc_attr( $carousel_classes ); ?> <?php echo esc_attr( $extra_class ); ?>" <?php echo woodmart_get_owl_attributes( $parsed_atts ); ?>>
