		...
		<div id="<?php echo esc_attr( $id ); ?>" class="<?php echo esc_attr( $classes ); ?>">
				...
				<?php if ( $image_primary ): ?>
					<div class="woodmart-timeline-image" >
						<?php if ( function_exists( 'wpb_getImageBySize' ) ) : ?>
							<?php echo wpb_getImageBySize( array( 'attach_id' => $image_primary, 'thumb_size' => $img_size_primary ) )['thumbnail']; ?>
						<?php endif; ?>
					</div>
				<?php endif ?>
			...
			<div class="timeline-col timeline-col-secondary">	
				...
				<?php if ( $image_secondary ): ?>
					<div class="woodmart-timeline-image" >
						<?php if ( function_exists( 'wpb_getImageBySize' ) ) : ?>
							<?php echo wpb_getImageBySize( array( 'attach_id' => $image_secondary, 'thumb_size' => $img_size_secondary ) )['thumbnail']; ?>
						<?php endif; ?>
					</div>
				<?php endif ?>
