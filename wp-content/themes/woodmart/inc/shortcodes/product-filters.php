...
if ( ! function_exists( 'woodmart_filters_categories_shortcode' ) ) {
	function woodmart_filters_categories_shortcode( $atts, $content ) {
		...
		$output = '<div class="woodmart-pf-checkboxes woodmart-pf-categories">';
			$output .= '<div class="woodmart-pf-title"><span class="title-text">' . esc_html( $title ) . '</span><ul class="woodmart-pf-results"></ul></div>';
			$output .= '<div class="woodmart-pf-dropdown woodmart-scroll">';
				$output .= '<ul class="woodmart-scroll-content">';
