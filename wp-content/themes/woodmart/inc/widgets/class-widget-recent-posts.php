					...
					<?php while ( $posts->have_posts() ) : $posts->the_post(); ?>
						<li>
							...
							<div class="recent-posts-info">
								<h5 class="entry-title"><a href="<?php echo esc_url( get_permalink() ) ?>" title="<?php echo sprintf( esc_attr__( 'Permalink to %s', 'woodmart' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php echo esc_attr( get_the_title() ); ?></a></h5>
