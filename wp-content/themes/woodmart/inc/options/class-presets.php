				...
				<div class="xts-presets-inner">
					<?php if ( self::get_current_preset() ) : ?>
						<div class="xts-current-preset">
							...
							<div class="xts-preset-conditions">
								<strong><?php esc_html_e( 'Conditions', 'woodmart' ); ?></strong>
								<form action="">
									<?php self::display_current_conditions(); ?>
									<a href="#" class="xts-add-preset-rule">+</a>
									<?php wp_nonce_field( 'xts-preset-form' ); ?>
									<div>
										<button type="submit"><?php esc_html_e( 'Save conditions', 'woodmart' ); ?></button>
									</div>
								</form>
							</div>
						</div>
					...
					<div class="xts-presets-list">
						...
						<?php if ( is_array( self::$presets ) && count( self::$presets ) ) : ?>
							<h3><?php esc_html_e( 'Options presets', 'woodmart' ); ?></h3>
							...
							<?php endforeach; ?>
						<?php else : ?>
							<p><?php esc_html_e( 'There are no custom presets yet.', 'woodmart' ); ?></p>
						<?php endif; ?>

						<button class="xts-add-new-preset"><?php esc_html_e( 'Create a new preset', 'woodmart' ); ?></button>
