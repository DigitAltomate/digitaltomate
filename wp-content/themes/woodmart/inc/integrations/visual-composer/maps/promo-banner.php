	...
	function woodmart_get_banner_params() {
		...
		return apply_filters( 'woodmart_get_banner_params', array(
			...
			*/
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__( 'Image type', 'woodmart' ),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__( 'Image background position', 'woodmart' ),
				'param_name' => 'image_bg_position',
				'value' => array(
					esc_html__( 'Center', 'xts-theme' ) => 'center',
					esc_html__( 'Top', 'xts-theme' ) => 'top',
					esc_html__( 'Bottom', 'xts-theme' ) => 'bottom',
			...
			*/
			...
			array(
				...
				'value' => array(
					esc_html__( 'Default (20px)', 'woodmart' ) => 'default',
					esc_html__( 'Small (16px)', 'woodmart' ) => 'small',
					esc_html__( 'Large (28px)', 'woodmart' ) => 'large',
					esc_html__( 'Extra Large (34px)', 'woodmart' ) => 'extra-large',
				),
				'edit_field_class' => 'vc_col-sm-6 vc_column',
			),
			array(
