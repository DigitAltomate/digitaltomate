				...
				<?php foreach ( $settings['items'] as $index => $item ) : ?>
					...
					$this->add_render_attribute(
						[
							...
							$repeater_value_key    => [
								'class' => [
									'woodmart-price-value',
								],
							],
							$repeater_suffix_key   => [
								'class' => [
									'woodmart-price-suffix',
								],
							],
							$repeater_currency_key => [
								'class' => [
									'woodmart-price-currency',
								],
							],
							$repeater_btn_key => [
								'class' => [
					...
					if ( 'product' === $settings['button_type'] && $product ) {
						$this->add_render_attribute( $repeater_footer_key, 'class', 'wd-add-btn-replace' );
					}
