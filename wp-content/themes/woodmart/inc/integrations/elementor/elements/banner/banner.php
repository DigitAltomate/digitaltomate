...
if ( ! function_exists( 'woodmart_elementor_banner_template' ) ) {
	function woodmart_elementor_banner_carousel_template( $settings ) {
		...
		$wrapper_classes .= ' woodmart-carousel-spacing-' . $settings['slider_spacing'];

		?>
		<div class="woodmart-carousel-container banners-carousel-wrapper<?php echo esc_attr( $wrapper_classes ); ?>" <?php echo woodmart_get_owl_attributes( $settings ); ?>>
...
if ( ! function_exists( 'woodmart_elementor_banner_template' ) ) {
	function woodmart_elementor_banner_template( $settings ) {
		...
		// Banner classes.
		$banner_classes .= ' banner-vr-align-' . $settings['vertical_alignment'];
		$banner_classes .= ' banner-hr-align-' . $settings['horizontal_alignment'];
		...
		$title_wrapper_classes .= ' banner-title-' . $settings['title_size'];
		...
		$inner_classes .= ' content-size-' . $settings['content_text_size'];
				...
				<div class="wrapper-content-banner">
					<div class="content-banner<?php echo esc_attr( $content_classes ); ?>">
						...
						<?php if ( $settings['subtitle'] ) : ?>
							<span class="banner-subtitle<?php echo esc_attr( $subtitle_classes ); ?>" data-elementor-setting-key="subtitle">
					...
					<?php if ( $settings['content'] ) : ?>
						<div class="banner-inner reset-mb-10<?php echo esc_attr( $inner_classes ); ?>" data-elementor-setting-key="content">
