					...
					<div class="member-social">
						<div <?php echo $this->get_render_attribute_string( 'social' ); ?>>
							<?php if ( $settings['facebook'] ) : ?>
								<a class="woodmart-social-icon social-facebook" href="<?php echo esc_url( $settings['facebook'] ); ?>">
									<i></i>
								</a>
							<?php endif; ?>
							
							<?php if ( $settings['twitter'] ) : ?>
								<a class="woodmart-social-icon social-twitter" href="<?php echo esc_url( $settings['twitter'] ); ?>">
									<i></i>
								</a>
							<?php endif; ?>
							
							<?php if ( $settings['linkedin'] ) : ?>
								<a class="woodmart-social-icon social-linkedin" href="<?php echo esc_url( $settings['linkedin'] ); ?>">
									<i></i>
								</a>
							<?php endif; ?>
							
							<?php if ( $settings['skype'] ) : ?>
								<a class="woodmart-social-icon social-skype" href="<?php echo esc_url( $settings['skype'] ); ?>">
									<i></i>
								</a>
							<?php endif; ?>
							
							<?php if ( $settings['instagram'] ) : ?>
								<a class="woodmart-social-icon social-instagram" href="<?php echo esc_url( $settings['instagram'] ); ?>">
									<i></i>
								</a>
							<?php endif; ?>
						</div>
