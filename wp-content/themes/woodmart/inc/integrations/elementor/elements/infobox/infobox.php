...
if ( ! function_exists( 'woodmart_elementor_infobox_carousel_template' ) ) {
	function woodmart_elementor_infobox_carousel_template( $settings ) {
		...
		?>
		<div class="woodmart-carousel-container info-box-carousel-wrapper<?php echo esc_attr( $wrapper_classes ); ?>" <?php echo woodmart_get_owl_attributes( $settings ); ?>>
...
if ( ! function_exists( 'woodmart_elementor_infobox_template' ) ) {
	function woodmart_elementor_infobox_template( $settings ) {
		...
		$wrapper_classes .= ' box-title-' . $settings['title_size'];
		$wrapper_classes .= $settings['wrapper_classes'] ? ' ' . $settings['wrapper_classes'] : '';
		if ( 'bg-hover' === $settings['style'] ) {
			$wrapper_classes .= ' hover-color-scheme-' . $settings['woodmart_hover_color_scheme'];
		}
		...
		<div class="info-box-wrapper">
			<div class="woodmart-info-box<?php echo esc_attr( $wrapper_classes ); ?>"<?php echo $settings['link']['url'] && ! woodmart_elementor_is_edit_mode() ? 'onclick="' . $onclick . '"' : ''; ?>>
				...
				<div class="info-box-content">
					...
					<?php if ( $settings['title'] ) : ?>
						...
						class="info-box-title<?php echo esc_attr( $title_classes ); ?>" data-elementor-setting-key="title">
								<?php echo nl2br( $settings['title'] ); ?>
						</<?php echo esc_attr( $settings['title_tag'] ); ?>>
					<?php endif; ?>

					<div class="info-box-inner reset-mb-10<?php echo esc_attr( $content_classes ); ?>"
