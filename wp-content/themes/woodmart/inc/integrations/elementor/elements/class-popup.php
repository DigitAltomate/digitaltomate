...
class Popup extends Widget_Base {
	...
	protected function render() {
		...
		$settings['custom_classes'] = 'woodmart-open-popup';
		
		?>
		<?php woodmart_elementor_button_template( $settings ); ?>
		<?php if ( $settings['content'] ) : ?>
			<div id="<?php echo esc_attr( $settings['popup_id'] ); ?>" class="mfp-with-anim woodmart-content-popup mfp-hide" style="max-width:<?php echo esc_attr( $settings['width']['size'] ); ?>px;">
