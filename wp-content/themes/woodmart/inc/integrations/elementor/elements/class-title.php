		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'extra-large' => esc_html__( 'Extra Large (48px)', 'woodmart' ),
				],
				'default' => 'default',
			]
		);
		...
		$this->add_render_attribute(
			[
				'wrapper'     => [
					'class' => [
						'title-wrapper',
						'woodmart-title-color-' . $settings['color'],
						'woodmart-title-style-' . $settings['style'],
						'woodmart-title-size-' . $settings['size'],
						'text-' . $settings['align'],
					],
				],
				'subtitle'    => [
