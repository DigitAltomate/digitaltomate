	...
	public function remove_btn() {
		?>
			<div class="wd-button-remove-wrap">
				<a href="#" class="woodmart-wishlist-remove wd-cross-button wd-with-text-left" data-key="<?php echo esc_attr( wp_create_nonce( 'woodmart-wishlist-remove' ) ); ?>" data-product-id="<?php echo esc_attr( get_the_ID() ); ?>">
