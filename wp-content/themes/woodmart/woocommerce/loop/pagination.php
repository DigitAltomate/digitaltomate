	...
	<div class="products-footer">
		<?php if ( $pagination == 'more-btn' || $pagination == 'infinit' ): ?>
			<?php if( get_next_posts_link() ) :?>
				<a href="<?php echo next_posts( $wp_query->max_num_pages, false ); ?>" rel="nofollow" class="btn woodmart-load-more woodmart-products-load-more load-on-<?php echo 'more-btn' === $pagination ? 'click' : 'scroll'; ?>"><span class="load-more-label"><?php esc_html_e('Load more products', 'woodmart'); ?></span></a>
