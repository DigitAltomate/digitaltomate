...
class HubSpotApiClient {
	 ...
	 */
	public static function make_request( $api_path, $method, $headers = array() ) {
		...
		if ( is_wp_error( $request ) ) {
			throw new \Exception( 'WP HTTP Error', 500 );
		}
	 ...
	 */
	public static function authenticated_request( $api_path, $method ) {
