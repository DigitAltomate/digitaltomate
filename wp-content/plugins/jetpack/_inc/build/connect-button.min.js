...
r.fetchPlanType().always(function(){if(r.isPaidPlan){var n=document.createElement("a");n.href=jpConnect.dashboardUrl;var e=window.location.pathname===n.pathname&&window.location.hash!==n.hash;window.location.assign(jpConnect.dashboardUrl),e&&window.location.reload(!0)}else window.location.assign(jpConnect.plansPromptUrl)})},handleConnectionError:function(n){r.isRegistering=!1,r.handleOriginalFlow()}},l=location.hash.replace(/(#\/setup).*/,"setup");c=location.hash.split("&from=")[1],"setup"===l&&(o.length&&o.hide(),r.selectAndStartConnectionFlow())});