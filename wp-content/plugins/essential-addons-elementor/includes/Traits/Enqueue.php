...
trait Enqueue
{
    ...
    {
        $version = defined('WP_DEBUG') ? time() : EAEL_PRO_PLUGIN_VERSION; // stop cache on debug mode
    ...
    public function script_localizer($object)
    {
        ...
        $object['eael_translate_text'] = [
            'required_text' => esc_html__('is a required field', 'essential-addons-elementor'),
            'invalid_text'  => esc_html__('Invalid', 'essential-addons-elementor'),
            'billing_text'  => esc_html__('Billing', 'essential-addons-elementor'),
        ];
