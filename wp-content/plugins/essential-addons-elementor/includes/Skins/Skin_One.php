...
class Skin_One extends Skin_Base
{
    ...
    public function render()
    {
        ...
        $menu_classes = ['eael-advanced-menu', $settings['skin_one_eael_advanced_menu_dropdown_animation'], 'eael-advanced-menu-indicator'];
        ...
        $this->parent->add_render_attribute('eael-advanced-menu', [
            ...
            'data-indicator-class' => $settings['skin_one_eael_advanced_menu_item_indicator'],
            'data-dropdown-indicator-class' => $settings['skin_one_eael_advanced_menu_dropdown_item_indicator'],
        ]);
