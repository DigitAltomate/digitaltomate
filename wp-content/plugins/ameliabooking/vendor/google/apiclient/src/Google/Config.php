...
class AmeliaGoogle_Config
{
  ...
  /**
   * Create a new AmeliaGoogle_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'AmeliaGoogle_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'AmeliaGoogle_Cache_File',
      'logger_class'  => 'AmeliaGoogle_Logger_Null',
      ...
      'classes' => array(
        'AmeliaGoogle_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'AmeliaGoogle_IO_Curl' => array(
          'disable_proxy_workaround' => false,
          'options' => null,
        ),
        'AmeliaGoogle_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'AmeliaGoogle_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'AmeliaGoogle_Http_Request' => array(
        ...
        'AmeliaGoogle_Auth_OAuth2' => array(
        ...
        'AmeliaGoogle_Task_Runner' => array(
        ...
        'AmeliaGoogle_Service_Exception' => array(
          'retry_map' => array(
        ...
        'AmeliaGoogle_IO_Exception' => array(
        ...
        'AmeliaGoogle_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/AmeliaGoogle_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see AmeliaGoogle_Auth_LoginTicket) after sign
