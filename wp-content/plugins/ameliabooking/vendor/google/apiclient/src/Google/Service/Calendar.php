 ...
 * @author Google, Inc.
 */
class AmeliaGoogle_Service_Calendar extends AmeliaGoogle_Service
{
   ...
   *
   * @param AmeliaGoogle_Client $client
   */
  public function __construct(AmeliaGoogle_Client $client)
  {
    ...
    $this->acl = new AmeliaGoogle_Service_Calendar_Acl_Resource(
        $this,
        $this->serviceName,
        'acl',
        array(
    ...
    $this->calendarList = new AmeliaGoogle_Service_Calendar_CalendarList_Resource(
        $this,
        $this->serviceName,
        'calendarList',
        array(
    ...
    $this->calendars = new AmeliaGoogle_Service_Calendar_Calendars_Resource(
        $this,
        $this->serviceName,
        'calendars',
        array(
    ...
    $this->channels = new AmeliaGoogle_Service_Calendar_Channels_Resource(
        $this,
        $this->serviceName,
        'channels',
        array(
    ...
    $this->colors = new AmeliaGoogle_Service_Calendar_Colors_Resource(
        $this,
        $this->serviceName,
        'colors',
        array(
    ...
    $this->events = new AmeliaGoogle_Service_Calendar_Events_Resource(
        $this,
        $this->serviceName,
        'events',
        array(
    ...
    $this->freebusy = new AmeliaGoogle_Service_Calendar_Freebusy_Resource(
        $this,
        $this->serviceName,
        'freebusy',
        array(
    ...
    $this->settings = new AmeliaGoogle_Service_Calendar_Settings_Resource(
        $this,
        $this->serviceName,
        'settings',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $calendarService = new AmeliaGoogle_Service_Calendar(...);
 *   $acl = $calendarService->acl;
 *  </code>
 */
class AmeliaGoogle_Service_Calendar_Acl_Resource extends AmeliaGoogle_Service_Resource
{
   ...
   * @param string $ruleId ACL rule identifier.
   * @param array $optParams Optional parameters.
   * @return AmeliaGoogle_Service_Calendar_AclRule
   */
  public function get($calendarId, $ruleId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AmeliaGoogle_Service_Calendar_AclRule");
  }
   ...
   * the calendarList.list method. If you want to access the primary calendar of
   * the currently logged in user, use the "primary" keyword.
   * @param AmeliaGoogle_AclRule $postBody
   * @param array $optParams Optional parameters.
   * @return AmeliaGoogle_Service_Calendar_AclRule
   */
  public function insert($calendarId, AmeliaGoogle_Service_Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "AmeliaGoogle_Service_Calendar_AclRule");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_Acl
   */
  public function listAcl($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AmeliaGoogle_Service_Calendar_Acl");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_AclRule
   */
  public function patch($calendarId, $ruleId, AmeliaGoogle_Service_Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "AmeliaGoogle_Service_Calendar_AclRule");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_AclRule
   */
  public function update($calendarId, $ruleId, AmeliaGoogle_Service_Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "AmeliaGoogle_Service_Calendar_AclRule");
  }
   ...
   * the calendarList.list method. If you want to access the primary calendar of
   * the currently logged in user, use the "primary" keyword.
   * @param AmeliaGoogle_Channel $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param int maxResults Maximum number of entries returned on one result
   * page. By default the value is 100 entries. The page size can never be larger
   ...
   * without any syncToken. Learn more about incremental synchronization.
   * Optional. The default is to return all entries.
   * @return AmeliaGoogle_Service_Calendar_Channel
   */
  public function watch($calendarId, AmeliaGoogle_Service_Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "AmeliaGoogle_Service_Calendar_Channel");
  }
}
 ...
 *  </code>
 */
class AmeliaGoogle_Service_Calendar_CalendarList_Resource extends AmeliaGoogle_Service_Resource
{
   ...
   * the currently logged in user, use the "primary" keyword.
   * @param array $optParams Optional parameters.
   * @return AmeliaGoogle_Service_Calendar_CalendarListEntry
   */
  public function get($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AmeliaGoogle_Service_Calendar_CalendarListEntry");
  }

  /**
   * Adds an entry to the user's calendar list. (calendarList.insert)
   *
   * @param AmeliaGoogle_CalendarListEntry $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return AmeliaGoogle_Service_Calendar_CalendarListEntry
   */
  public function insert(AmeliaGoogle_Service_Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "AmeliaGoogle_Service_Calendar_CalendarListEntry");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_CalendarList
   */
  public function listCalendarList($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AmeliaGoogle_Service_Calendar_CalendarList");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_CalendarListEntry
   */
  public function patch($calendarId, AmeliaGoogle_Service_Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "AmeliaGoogle_Service_Calendar_CalendarListEntry");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_CalendarListEntry
   */
  public function update($calendarId, AmeliaGoogle_Service_Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "AmeliaGoogle_Service_Calendar_CalendarListEntry");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_Channel
   */
  public function watch(AmeliaGoogle_Service_Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "AmeliaGoogle_Service_Calendar_Channel");
 ...
 *  </code>
 */
class AmeliaGoogle_Service_Calendar_Calendars_Resource extends AmeliaGoogle_Service_Resource
{
   ...
   * the currently logged in user, use the "primary" keyword.
   * @param array $optParams Optional parameters.
   * @return AmeliaGoogle_Service_Calendar_Calendar
   */
  public function get($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AmeliaGoogle_Service_Calendar_Calendar");
  }

  /**
   * Creates a secondary calendar. (calendars.insert)
   *
   * @param AmeliaGoogle_Calendar $postBody
   * @param array $optParams Optional parameters.
   * @return AmeliaGoogle_Service_Calendar_Calendar
   */
  public function insert(AmeliaGoogle_Service_Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "AmeliaGoogle_Service_Calendar_Calendar");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_Calendar
   */
  public function patch($calendarId, AmeliaGoogle_Service_Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "AmeliaGoogle_Service_Calendar_Calendar");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_Calendar
   */
  public function update($calendarId, AmeliaGoogle_Service_Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "AmeliaGoogle_Service_Calendar_Calendar");
  }
}
 ...
 *  </code>
 */
class AmeliaGoogle_Service_Calendar_Channels_Resource extends AmeliaGoogle_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   */
  public function stop(AmeliaGoogle_Service_Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
 ...
 *  </code>
 */
class AmeliaGoogle_Service_Calendar_Colors_Resource extends AmeliaGoogle_Service_Resource
{
   ...
   *
   * @param array $optParams Optional parameters.
   * @return AmeliaGoogle_Service_Calendar_Colors
   */
  public function get($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AmeliaGoogle_Service_Calendar_Colors");
  }
}
 ...
 *  </code>
 */
class AmeliaGoogle_Service_Calendar_Events_Resource extends AmeliaGoogle_Service_Resource
{
  ...
  public function get($calendarId, $eventId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AmeliaGoogle_Service_Calendar_Event");
  }
   ...
   * the calendarList.list method. If you want to access the primary calendar of
   * the currently logged in user, use the "primary" keyword.
   * @param AmeliaGoogle_Event $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return AmeliaGoogle_Service_Calendar_Event
   */
  public function import($calendarId, AmeliaGoogle_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('import', array($params), "AmeliaGoogle_Service_Calendar_Event");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_Event
   */
  public function insert($calendarId, AmeliaGoogle_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "AmeliaGoogle_Service_Calendar_Event");
  }
   ...
   * @opt_param string timeZone Time zone used in the response. Optional. The
   * default is the time zone of the calendar.
   * @return AmeliaGoogle_Service_Calendar_Events
   */
  public function instances($calendarId, $eventId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId);
    $params = array_merge($params, $optParams);
    return $this->call('instances', array($params), "AmeliaGoogle_Service_Calendar_Events");
  }
  ...
  public function listEvents($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AmeliaGoogle_Service_Calendar_Events");
  }
  ...
  public function move($calendarId, $eventId, $destination, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('move', array($params), "AmeliaGoogle_Service_Calendar_Event");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_Event
   */
  public function patch($calendarId, $eventId, AmeliaGoogle_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "AmeliaGoogle_Service_Calendar_Event");
  }
  ...
  public function quickAdd($calendarId, $text, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('quickAdd', array($params), "AmeliaGoogle_Service_Calendar_Event");
  }
   ...
   * @return AmeliaGoogle_Service_Calendar_Event
   */
  public function update($calendarId, $eventId, AmeliaGoogle_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "AmeliaGoogle_Service_Calendar_Event");
  }
 ...
 *  </code>
 */
class AmeliaGoogle_Service_Calendar_Freebusy_Resource extends AmeliaGoogle_Service_Resource
{

  /**
   * Returns free/busy information for a set of calendars. (freebusy.query)
   *
   * @param AmeliaGoogle_FreeBusyRequest $postBody
   * @param array $optParams Optional parameters.
   * @return AmeliaGoogle_Service_Calendar_FreeBusyResponse
   */
  public function query(AmeliaGoogle_Service_Calendar_FreeBusyRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "AmeliaGoogle_Service_Calendar_FreeBusyResponse");
  }
}
 ...
 *  </code>
 */
class AmeliaGoogle_Service_Calendar_Settings_Resource extends AmeliaGoogle_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return AmeliaGoogle_Service_Calendar_Setting
   */
  public function get($setting, $optParams = array())
  {
    $params = array('setting' => $setting);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "AmeliaGoogle_Service_Calendar_Setting");
  }
   ...
   * synchronization. Optional. The default is to return all entries.
   * @return AmeliaGoogle_Service_Calendar_Settings
   */
  public function listSettings($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "AmeliaGoogle_Service_Calendar_Settings");
  }
...
class AmeliaGoogle_Service_Calendar_Acl extends AmeliaGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'AmeliaGoogle_Service_Calendar_AclRule';
...
class AmeliaGoogle_Service_Calendar_AclRule extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  ...
  public $kind;
  public $role;
  protected $scopeType = 'AmeliaGoogle_Service_Calendar_AclRuleScope';
  ...
  public function setScope(AmeliaGoogle_Service_Calendar_AclRuleScope $scope)
  {
    $this->scope = $scope;
  }
...
class AmeliaGoogle_Service_Calendar_AclRuleScope extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $type;
...
class AmeliaGoogle_Service_Calendar_Calendar extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class AmeliaGoogle_Service_Calendar_CalendarList extends AmeliaGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'AmeliaGoogle_Service_Calendar_CalendarListEntry';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class AmeliaGoogle_Service_Calendar_CalendarListEntry extends AmeliaGoogle_Collection
{
  ...
  public $colorId;
  protected $defaultRemindersType = 'AmeliaGoogle_Service_Calendar_EventReminder';
  ...
  public $kind;
  public $location;
  protected $notificationSettingsType = 'AmeliaGoogle_Service_Calendar_CalendarListEntryNotificationSettings';
  ...
  public function setNotificationSettings(AmeliaGoogle_Service_Calendar_CalendarListEntryNotificationSettings $notificationSettings)
  {
...
class AmeliaGoogle_Service_Calendar_CalendarListEntryNotificationSettings extends AmeliaGoogle_Collection
{
  protected $collection_key = 'notifications';
  protected $internal_gapi_mappings = array(
  );
  protected $notificationsType = 'AmeliaGoogle_Service_Calendar_CalendarNotification';
...
class AmeliaGoogle_Service_Calendar_CalendarNotification extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $method;
...
class AmeliaGoogle_Service_Calendar_Channel extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
...
class AmeliaGoogle_Service_Calendar_ColorDefinition extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $background;
...
class AmeliaGoogle_Service_Calendar_Colors extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $calendarType = 'AmeliaGoogle_Service_Calendar_ColorDefinition';
  protected $calendarDataType = 'map';
  protected $eventType = 'AmeliaGoogle_Service_Calendar_ColorDefinition';
...
class AmeliaGoogle_Service_Calendar_Error extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $domain;
...
class AmeliaGoogle_Service_Calendar_Event extends AmeliaGoogle_Collection
{
  protected $collection_key = 'recurrence';
  protected $internal_gapi_mappings = array(
  );
  public $anyoneCanAddSelf;
  protected $attachmentsType = 'AmeliaGoogle_Service_Calendar_EventAttachment';
  protected $attachmentsDataType = 'array';
  protected $attendeesType = 'AmeliaGoogle_Service_Calendar_EventAttendee';
  protected $attendeesDataType = 'array';
  public $attendeesOmitted;
  public $colorId;
  public $created;
  protected $creatorType = 'AmeliaGoogle_Service_Calendar_EventCreator';
  protected $creatorDataType = '';
  public $description;
  protected $endType = 'AmeliaGoogle_Service_Calendar_EventDateTime';
  protected $endDataType = '';
  public $endTimeUnspecified;
  public $etag;
  protected $extendedPropertiesType = 'AmeliaGoogle_Service_Calendar_EventExtendedProperties';
  protected $extendedPropertiesDataType = '';
  protected $gadgetType = 'AmeliaGoogle_Service_Calendar_EventGadget';
  ...
  public $location;
  public $locked;
  protected $organizerType = 'AmeliaGoogle_Service_Calendar_EventOrganizer';
  protected $organizerDataType = '';
  protected $originalStartTimeType = 'AmeliaGoogle_Service_Calendar_EventDateTime';
  protected $originalStartTimeDataType = '';
  public $privateCopy;
  public $recurrence;
  public $recurringEventId;
  protected $remindersType = 'AmeliaGoogle_Service_Calendar_EventReminders';
  protected $remindersDataType = '';
  public $sequence;
  protected $sourceType = 'AmeliaGoogle_Service_Calendar_EventSource';
  protected $sourceDataType = '';
  protected $startType = 'AmeliaGoogle_Service_Calendar_EventDateTime';
  ...
  public function setCreator(AmeliaGoogle_Service_Calendar_EventCreator $creator)
  {
  ...
  public function setEnd(AmeliaGoogle_Service_Calendar_EventDateTime $end)
  {
    $this->end = $end;
  }
  ...
  public function setExtendedProperties(AmeliaGoogle_Service_Calendar_EventExtendedProperties $extendedProperties)
  {
  ...
  public function setGadget(AmeliaGoogle_Service_Calendar_EventGadget $gadget)
  {
    $this->gadget = $gadget;
  }
  ...
  public function setOrganizer(AmeliaGoogle_Service_Calendar_EventOrganizer $organizer)
  {
  ...
  public function setOriginalStartTime(AmeliaGoogle_Service_Calendar_EventDateTime $originalStartTime)
  {
  ...
  public function setReminders(AmeliaGoogle_Service_Calendar_EventReminders $reminders)
  {
  ...
  public function setSource(AmeliaGoogle_Service_Calendar_EventSource $source)
  {
    $this->source = $source;
  }
  ...
  public function setStart(AmeliaGoogle_Service_Calendar_EventDateTime $start)
  {
    $this->start = $start;
  }
...
class AmeliaGoogle_Service_Calendar_EventAttachment extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $fileId;
...
class AmeliaGoogle_Service_Calendar_EventAttendee extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class AmeliaGoogle_Service_Calendar_EventCreator extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
...
class AmeliaGoogle_Service_Calendar_EventDateTime extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $date;
...
class AmeliaGoogle_Service_Calendar_EventExtendedProperties extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $private;
...
class AmeliaGoogle_Service_Calendar_EventGadget extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $display;
...
class AmeliaGoogle_Service_Calendar_EventOrganizer extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
...
class AmeliaGoogle_Service_Calendar_EventReminder extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $method;
...
class AmeliaGoogle_Service_Calendar_EventReminders extends AmeliaGoogle_Collection
{
  protected $collection_key = 'overrides';
  protected $internal_gapi_mappings = array(
  );
  protected $overridesType = 'AmeliaGoogle_Service_Calendar_EventReminder';
...
class AmeliaGoogle_Service_Calendar_EventSource extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $title;
...
class AmeliaGoogle_Service_Calendar_Events extends AmeliaGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  ...
  public $description;
  public $etag;
  protected $itemsType = 'AmeliaGoogle_Service_Calendar_Event';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class AmeliaGoogle_Service_Calendar_FreeBusyCalendar extends AmeliaGoogle_Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $busyType = 'AmeliaGoogle_Service_Calendar_TimePeriod';
  protected $busyDataType = 'array';
  protected $errorsType = 'AmeliaGoogle_Service_Calendar_Error';
...
class AmeliaGoogle_Service_Calendar_FreeBusyGroup extends AmeliaGoogle_Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
...
class AmeliaGoogle_Service_Calendar_FreeBusyRequest extends AmeliaGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  ...
  protected $itemsType = 'AmeliaGoogle_Service_Calendar_FreeBusyRequestItem';
  protected $itemsDataType = 'array';
  public $timeMax;
  public $timeMin;
  public $timeZone;
...
class AmeliaGoogle_Service_Calendar_FreeBusyRequestItem extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class AmeliaGoogle_Service_Calendar_FreeBusyResponse extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $calendarsType = 'AmeliaGoogle_Service_Calendar_FreeBusyCalendar';
  protected $calendarsDataType = 'map';
  protected $groupsType = 'AmeliaGoogle_Service_Calendar_FreeBusyGroup';
...
class AmeliaGoogle_Service_Calendar_Setting extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
...
class AmeliaGoogle_Service_Calendar_Settings extends AmeliaGoogle_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'AmeliaGoogle_Service_Calendar_Setting';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class AmeliaGoogle_Service_Calendar_TimePeriod extends AmeliaGoogle_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $end;
