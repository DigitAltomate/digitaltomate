 ...
 */
class AmeliaGoogle_Cache_Memcache extends AmeliaGoogle_Cache_Abstract
{
  ...
  public function __construct(AmeliaGoogle_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new AmeliaGoogle_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws AmeliaGoogle_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new AmeliaGoogle_Cache_Exception("Couldn't store data in cache");
    }
