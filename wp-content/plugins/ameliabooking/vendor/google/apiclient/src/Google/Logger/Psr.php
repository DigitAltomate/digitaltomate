 ...
 * with the `AmeliaGoogle_Logger_Psr::setLogger()` method.
 */
class AmeliaGoogle_Logger_Psr extends AmeliaGoogle_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(AmeliaGoogle_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
