 ...
 * @property \AmeliaStripe\Collection $balance_transactions
 * @property Card $card
 ...
 * @property \AmeliaStripe\Collection $transactions
 * @property mixed $verification_data
 *
 * @package AmeliaStripe\Issuing
 */
class Authorization extends \AmeliaStripe\ApiResource
{
