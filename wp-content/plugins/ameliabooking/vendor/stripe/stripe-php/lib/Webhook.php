...
abstract class Webhook
{
     ...
     * \AmeliaStripe\SignatureVerificationException if the signature verification
     ...
     * @return \AmeliaStripe\Event the Event instance
     * @throws \UnexpectedValueException if the payload is not valid JSON,
     * @throws \AmeliaStripe\Error\SignatureVerification if the verification fails.
     */
