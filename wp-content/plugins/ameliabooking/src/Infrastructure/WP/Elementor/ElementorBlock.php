...
class ElementorBlock
{
    ...
    public function register_widgets()
    {
        ...
        Plugin::instance()->widgets_manager->register_widget_type(new AmeliaSearchElementorWidget());
        Plugin::instance()->widgets_manager->register_widget_type(new AmeliaCatalogElementorWidget());
        Plugin::instance()->widgets_manager->register_widget_type(new AmeliaEventsElementorWidget());
        Plugin::instance()->widgets_manager->register_widget_type(new AmeliaCustomerPanelElementorWidget());
        Plugin::instance()->widgets_manager->register_widget_type(new AmeliaEmployeePanelElementorWidget());
    }
