...
class DB {
	...
	public static function update_user_specific_login_meta( $meta_key, $value ) {
		return Login::get_link_my_account() != '' && Login::get_link_my_account() ? self::update_user_meta( get_current_user_id(), $meta_key, $value ) : self::update_option( $meta_key, $value );
	}
	...
	public static function get_user_specific_login_meta( $meta_key, $default = false, $single = true ) {
		return Login::get_link_my_account() != '' && Login::get_link_my_account() ? self::get_user_meta( get_current_user_id(), $meta_key, $default, $single ) : self::get_option( $meta_key, $default );
	}
	...
	public static function delete_user_specific_login_meta( $meta_key ) {
		return Login::get_link_my_account() != '' && Login::get_link_my_account() ? self::delete_user_meta( get_current_user_id(), $meta_key ) : self::delete_option( $meta_key );
	}
