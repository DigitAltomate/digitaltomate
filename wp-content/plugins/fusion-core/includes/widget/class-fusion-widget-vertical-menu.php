...
class Fusion_Widget_Vertical_Menu extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$widget_id_escaped = is_numeric( $args['widget_id'] ) ? 'avada-vertical-menu-widget-' . esc_attr( $args['widget_id'] ) : esc_attr( $args['widget_id'] ); // phpcs:ignore WordPress.Security.EscapeOutput
