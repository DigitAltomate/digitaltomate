...
$portfolio_one_column_text_pos = $fusion_settings->get( 'portfolio_archive_one_column_text_position' );
$portfolio_text_layout         = $fusion_settings->get( 'portfolio_archive_text_layout' );
$portfolio_content_length      = $fusion_settings->get( 'portfolio_archive_content_length' );
$portfolio_text_alignment      = $fusion_settings->get( 'portfolio_archive_text_alignment' );
$portfolio_columns_int         = $fusion_settings->get( 'portfolio_archive_columns' );
$portfolio_pagination_type     = $fusion_settings->get( 'portfolio_archive_pagination_type' );
$portfolio_image_size          = $fusion_settings->get( 'portfolio_archive_featured_image_size' );
$portfolio_image_size_set      = $portfolio_image_size;
$lazy_load                     = 'avada' === $fusion_settings->get( 'lazy_load' ) ? true : false;
