...
class Cached_Container extends Container
{
    ...
    protected function getSchemaBlocksService()
    {
        ...
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/src/schema-templates/address.block.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/src/schema-templates/address.schema.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/src/schema-templates/image.schema.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/src/schema-templates/ingredients.block.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/src/schema-templates/ingredients.schema.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/src/schema-templates/recipe.block.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/src/schema-templates/recipe.schema.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/src/schema-templates/step.block.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/src/schema-templates/step.schema.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/src/schema-templates/steps.block.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/src/schema-templates/steps.schema.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/premium/src/schema-templates/job-description.block.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/premium/src/schema-templates/job-description.schema.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/premium/src/schema-templates/job-posting.block.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/premium/src/schema-templates/job-posting.schema.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/premium/src/schema-templates/job-title.block.php');
        $instance->register_template('/var/jenkins/workspace/Plugin_Release/wordpress-seo-premium/.repos/wordpress-seo-premium/premium/src/schema-templates/job-title.schema.php');
    ...
    protected function getLoaderService()
    {
        ...
        $instance->register_integration('Yoast\\WP\\SEO\\Integrations\\Third_Party\\Elementor_Exclude_Post_Types');
