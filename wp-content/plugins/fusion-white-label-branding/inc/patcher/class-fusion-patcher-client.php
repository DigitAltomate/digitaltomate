...
class Fusion_Patcher_Client {
	...
	private function query_patch_server() {
		...
		if ( is_wp_error( $response ) ) {
			...
			new Fusion_Patcher_Admin_Notices( 'server-unreachable', esc_attr__( 'The ThemeFusion patches server could not be reached. Please contact your host to unblock the "https://updates.theme-fusion.com/" domain.', 'fusion-white-label-branding' ) );
			return false;
		}
