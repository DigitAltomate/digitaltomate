	...
	class Astra_Notices {
		...
		public function dismiss_notice() {
			...
			if ( false === wp_verify_nonce( $nonce, 'astra-notices' ) ) {
				wp_send_json_error( esc_attr_e( 'WordPress Nonce not validated.', 'uael' ) );
			}
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_style( 'uael-notice-settings', UAEL_URL . 'admin/assets/uael-admin-notice.css', array(), self::$version );
			wp_localize_script(
				'astra-notices',
				'astraNotices',
				array(
