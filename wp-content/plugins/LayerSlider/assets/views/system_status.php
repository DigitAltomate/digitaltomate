			...
			<table>
					...
					<tr class="<?php echo ! empty($test) ? '' : 'ls-info' ?>">
						...
						<td>
							...
							<span>
								...
								<?php echo '<a href="https://wordpress.org/support/article/debugging-in-wordpress/" target="_blank">'. __('Click here to learn more', 'LayerSlider') .'</a>' ?>
							</span>
							<?php endif ?>
						</td>
					</tr>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php if( ! $test ) : ?>
							<span><?php _e('Front-end sliders and the slider builder interface require the PHP DOMDocument extension and will not work properly without it.', 'LayerSlider') ?></span>
							<?php endif ?>
						</td>
					</tr>
					<tr>
