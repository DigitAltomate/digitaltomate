...
<div class="wrap">
	...
	<form method="post" id="ls-tr-builder-form">
		...
		<div class="ls-publish">
			...
			<?php else : ?>
			<?php echo sprintf(__('Before you can save your changes, you need to make your “/wp-content/uploads” folder writable. See the %sCodex%s', 'LayerSlider'), '<a href="https://wordpress.org/support/article/changing-file-permissions/" target="_blank">', '</a>') ?>
			<?php endif; ?>
		</div>
	</form>
</div>
