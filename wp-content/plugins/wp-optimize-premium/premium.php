...
class WP_Optimize_Premium {
	...
	public function __construct() {
		...
		add_filter('additional_options_updraft_slack_logger', array($this, 'additional_options_updraft_slack_logger'), 20, 4);
	 ...
	 * @param  string $logger_class
	 * @return string
	 */
	public function additional_options_updraft_slack_logger($additional_options_html, $logger_form_name, $logger_additional_options, $logger_class) {
	...
	public function include_lazy_load() {
		...
		$lazyload_options = wp_parse_args($options->get_option('lazyload'), array('images' => false, 'iframes' => false));
		if ($lazyload_options['images'] || $lazyload_options['iframes']) {
