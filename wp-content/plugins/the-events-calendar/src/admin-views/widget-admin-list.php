...
<p>
	...
	<label for="<?php echo esc_attr( $this->get_field_id( 'no_upcoming_events' ) ); ?>"><?php esc_html_e( 'Hide this widget if there are no upcoming events.', 'the-events-calendar' ); ?></label>
</p>
<p>
