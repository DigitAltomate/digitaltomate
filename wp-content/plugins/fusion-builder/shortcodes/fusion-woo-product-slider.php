				...
				[
					...
					'params'    => [
						...
						[
							...
							'description' => __( 'Defines how products should be ordered. NOTE: If Order by Price is not working, please regenerate the Product Lookup Tables <a href="' . $lookup_table_link . '" target="_blank">here</a>.', 'fusion-builder' ),
							'param_name'  => 'orderby',
							'default'     => 'date',
							'value'       => [
