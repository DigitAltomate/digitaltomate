		...
		class FusionSC_Title extends Fusion_Element {
			...
			public function render( $args, $content = '' ) {
				...
				if ( ! $is_flex_container ) {
					...
					if ( ! ( '' === $this->args['margin_top_medium'] && '' === $this->args['margin_bottom_medium'] ) ) {
						$style .= '@media only screen and (max-width:' . $fusion_settings->get( 'visibility_medium' ) . 'px) {';
						$style .= '.fusion-title.fusion-title-' . $this->title_counter . '{margin-top:' . $this->args['margin_top_medium'] . '!important;margin-bottom:' . $this->args['margin_bottom_medium'] . '!important;}';
						$style .= '}';
					} elseif ( ! ( '' === $this->args['margin_top'] && '' === $this->args['margin_bottom'] ) ) {
						...
						$style .= '@media only screen and (max-width:' . $fusion_settings->get( 'visibility_medium' ) . 'px) {';
						$style .= '.fusion-title.fusion-title-' . $this->title_counter . '{margin-top:' . $this->args['margin_top'] . '!important;margin-bottom:' . $this->args['margin_bottom'] . '!important;}';
						$style .= '}';
					}

					if ( ! ( '' === $this->args['margin_top_small'] && '' === $this->args['margin_bottom_small'] ) && ! ( '0px' === $this->args['margin_top_small'] && '20px' === $this->args['margin_bottom_small'] ) ) {
						$style .= '@media only screen and (max-width:' . $fusion_settings->get( 'visibility_small' ) . 'px) {';
						$style .= '.fusion-title.fusion-title-' . $this->title_counter . '{margin-top:' . $this->args['margin_top_small'] . '!important;margin-bottom:' . $this->args['margin_bottom_small'] . '!important;}';
						$style .= '}';
					}
				}
