			...
			[
				...
				'params'     => [
					...
					[
						...
						'description' => esc_attr__( 'Controls the color of the icon. Will fall back to the separator color, if no color is set here and in the Theme Option.', 'fusion-builder' ),
