...
class Fusion_Patcher_Filesystem {
	...
	public function get_remote( $url ) {
		...
		new Fusion_Patcher_Admin_Notices( 'no-patch-contents', esc_html__( 'The Avada patch contents cannot be retrieved. Please contact your host to unblock the "https://updates.theme-fusion.com/" domain.', 'fusion-builder' ) );
		return false;
	}
