...
class Fusion_Product_Registration {
	...
	public function the_form() {
		...
		<h2 class="avada-db-reg-heading">
			...
			<?php endif; ?>
			<span class="avada-db-reg-heading-text"><?php esc_html_e( 'Register Your Product', 'fusion-builder' ); ?></span>
			<span class="avada-db-card-heading-badge avada-db-card-heading-badge-howto">
				<i class="fusiona-help-outlined"></i>
				<span class="avada-db-card-heading-badge-text"><?php esc_html_e( 'How To?', 'fusion-builder' ); ?></span>
			</span>
		</h2>
		<div class="avada-db-reg-form-container">
			<?php if ( $is_registered ) : ?>
				<p class="avada-db-reg-text"><?php esc_html_e( 'Congratulations! Thank you for registering your product.', 'fusion-builder' ); ?></p>
			<?php else : ?>
				<p class="avada-db-reg-text"><?php esc_html_e( 'Please enter your Envato token and get access to our prebuilt websites, auto updates and premium plugins.', 'fusion-builder' ); ?></p>
			<?php endif; ?>
			...
			<form class="avada-db-reg-form" method="post">
				...
				<?php $reg_button_text = __( 'Register Now', 'fusion-builder' ); ?>
				<?php if ( $is_registered ) : ?>
					<?php $reg_button_text = __( 'Unregister', 'fusion-builder' ); ?>
			...
			<div class="avada-db-reg-howto">
				<h3 class="avada-db-reg-howto-heading"><?php esc_html_e( 'How To Generate A Token', 'fusion-builder' ); ?></h3>
